...
import { GlobalStyle } from '../../new-components/basics/shared/global';
import { Link, Icon, TooltipLinkList, WithTooltip, styles, site } from '../../new-components/basics';
        ...
        <NavGroup>
          <NavItem>
            <LogotypeWrapper href="/">
              <img src={imgLogo} alt="Flutter Widget Livebook" />
            </LogotypeWrapper>
