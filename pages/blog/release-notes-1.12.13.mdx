...
```dart liveslice=CupertinoDatePickerDarkMode
CupertinoApp(
...
```dart liveslice=CupertinoTimerPickerDarkMode
CupertinoApp(
  theme: const CupertinoThemeData(
    brightness: Brightness.dark,
  ),
...
```dart liveslice=CupertinoPageScaffoldDarkMode mockup=iPhone7
CupertinoApp(
  theme: const CupertinoThemeData(
    brightness: Brightness.dark,
  ),
...
```dart liveslice=CupertinoActionSheetDarkMode
CupertinoApp(
  theme: const CupertinoThemeData(
    brightness: Brightness.dark,
  ),
...
```dart liveslice=CupertinoActivityIndicatorDarkMode
CupertinoApp(
  theme: const CupertinoThemeData(
    brightness: Brightness.dark,
  ),
...
```dart liveslice=CupertinoButtonDarkMode
CupertinoApp(
  theme: const CupertinoThemeData(
    brightness: Brightness.dark,
  ),
...
```dart liveslice=CupertinoTabBarDarkMode
CupertinoApp(
  theme: const CupertinoThemeData(
    brightness: Brightness.dark,
  ),
...
```dart liveslice=CupertinoAlertDialogDarkMode
CupertinoApp(
  theme: const CupertinoThemeData(
    brightness: Brightness.dark,
  ),
...
```dart liveslice=CupertinoNavigationBarDarkMode
CupertinoApp(
  theme: const CupertinoThemeData(
    brightness: Brightness.dark,
  ),
...
[13005](https://github.com/flutter/engine/pull/13005) Auto-formatter fixes for [BUILD.gn](#) files
...
[13401](https://github.com/flutter/engine/pull/13401) Reformat [BUILD.gn](#) files to comply with the format checker presubmit script
...
We have made significant improvements in our plugins. We upgraded a set of plugins to support web development. Also, to support Add to App scenarios, we have a new set of APIs available for existing Android plugins to be upgraded to. If you are currently maintaining an Android plugin. We encourage you to check the [Migrating your plugin to the new APIs](https://flutter.dev/go/android-plugin-migration) documentation, and upgrade your plugins accordingly.
...
[2136](https://github.com/flutter/plugins/pull/2136) [url_launcher_web] Fix [README.md](#) pubspec example
