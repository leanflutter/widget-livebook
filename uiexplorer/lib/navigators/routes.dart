...
List<SliceExample> sliceExamples = [
  ...
  SliceCupertinoActionSheetDarkMode(),
  SliceCupertinoActivityIndicator(),
  SliceCupertinoActivityIndicatorDarkMode(),
  SliceCupertinoAlertDialog(),
  SliceCupertinoAlertDialogDarkMode(),
  SliceCupertinoButton(),
  SliceCupertinoButtonDarkMode(),
  SliceCupertinoContextMenu(),
  SliceCupertinoDatePicker(),
  SliceCupertinoDatePickerDarkMode(),
  SliceCupertinoNavigationBar(),
  SliceCupertinoNavigationBarDarkMode(),
  SliceCupertinoPageScaffold(),
  SliceCupertinoPageScaffoldDarkMode(),
  SliceCupertinoSlider(),
  SliceCupertinoSwitch(),
  SliceCupertinoTabBar(),
  SliceCupertinoTabBarDarkMode(),
  SliceCupertinoTimerPicker(),
  SliceCupertinoTimerPickerDarkMode(),
  SliceCustomPaint(),
